...
Kubernetes Deployment with `restartPolicy: Always` (default) is also
sufficient. The 100-URL budget is a build-time constant; tuning it
requires a code change and rebuild — runtime exposure (env/config/CLI)
